module AuthenticatedSystem
  protected
    ...
    # Preloads @current_<%= file_name %> with the user model if
    # they're logged in.
    def logged_in?
    ...
    # Set it to :false if login fails so that future calls do
    ...
    #
    # Override this method in your controllers if you want to
    # restrict access to only a few actions or if you want to
    # check if the <%= file_name %> has the correct rights.
    #
    # Example:
    #
    #  # only allow nonbobs
    ...
    #
    # To require logins for all actions, use this in your
    # controllers:
    #
    ...
    #
    # Override this method in your controllers if you want to
    # have special behavior in case the <%= file_name %> is not
    # authorized to access the requested action.  For example, a
    # popup window might simply close itself.
    def access_denied
    ...
    # Redirect to the URI stored by the most recent
    # store_location call or to the passed default.
    def redirect_back_or_default(default)
      session[:return_to] ? redirect_to_url(session[:return_to]) : redirect_to(default)
      session[:return_to] = nil
    end
    
    # Inclusion hook to make #current_<%= file_name %> and
    # #logged_in? available as ActionView helper methods.
