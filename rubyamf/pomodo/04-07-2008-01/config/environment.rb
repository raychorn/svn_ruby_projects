...
Rails::Initializer.run do |config|
  ...
  # default all plugins in vendor/plugins are loaded, in
  # alphabetical order
  # :all can be used as a placeholder for all plugins not
  # explicitly named.
  ...
  config.action_controller.session = {
    ...
    :secret      => 'cdce9c2b70b102c557ef7b1521cf78d6'
  }

  # Use the database for sessions instead of the cookie-based
  # default, which shouldn't be used to store highly
  # confidential information (create the session table with
  # 'rake db:sessions:create')
  # config.action_controller.session_store = :active_record_store

  # Use SQL instead of Active Record's schema dumper when
  # creating the test database. This is necessary if your schema
  # can't be completely dumped by the schema dumper, like if you
  # have constraints or database-specific column types
