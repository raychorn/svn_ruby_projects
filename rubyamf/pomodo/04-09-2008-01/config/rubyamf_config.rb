...
module RubyAMF
  module Configuration
    ...
    # A Class Mapping definition conists of at least these two
    # properties:
    ...
    # You can also specify a class mapping scope if you want.
    # For example, lets say you need certain attributes for a
    # book when you are viewing a book in Flex as opposed to
    # editing a book (where you would need more parameters). You
    # can define a scope mapping parameter for ":attributes"
    # or for ":associations." You're mapping would look
    # something like this:
    # ClassMappings.register(
    ...
    #   :attributes   => {:viewing => ["description", "title"],
    #                     :editing => ["id", "published_at",
    #                                  "theme_id"]}
    # Note the hash instead of an array used for the attributes.
    #
    # Now, to call the class mapping scope of editing (you are
    # sending objects to the editing application), your
    # controller call would look like this:
    # render :amf => book, :class_mapping_scope => :editing
    #
    # You can also specify a default scope to use. If you don't
    # set this and you don't specify a class mapping scope on an
    # attribute or association, then it will not have a scope to
    # use and will not add any attributes or associations
    # (whichever it cant match) to that association.
    # ClassMappings.default_mapping_scope = :viewing
  
    # => Date Conversion
    # Incoming dates from Flash by default are Time objects,
    # this can conver to DateTime if needed
    # ClassMappings.use_ruby_date_time = false
  
    # => Use Array Collection
    # By setting this to true, you opt in to using
    # ArrayCollections for all the Arrays generated by the body
    # of your request.
    # Note: This only works for amf3 with Remote Object, NOT
    # with Net Connection.
    ...
    # especally useful if you are sending huge objects
    ...
    # Incoming Remoting Parameter mappings allow you to map an
    # incoming requests parameters into rails' params hash
    #
    # Here's an example:
