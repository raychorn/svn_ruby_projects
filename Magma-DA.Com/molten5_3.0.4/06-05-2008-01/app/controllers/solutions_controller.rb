...
class SolutionsController < ProtectedController
  ...
  def show
    ...
    if !@solution.viewable? or (!@solution.portal_account_name_id__c.blank? and !current_contact.account_list.map { |a| a.id }.include?(@solution.portal_account_name_id__c))
