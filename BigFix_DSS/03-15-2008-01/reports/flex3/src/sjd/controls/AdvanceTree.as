package sjd.controls
{
	...
	public class AdvanceTree extends Tree{
		...
		[Event(name="dragMoveCompleted", type="com.bigfix.extensions.controls.advancetree.events.DragMoveCompletedEvent")]
					...
					if (event.dragInitiator == this) {
			        	...
			        	if (event.action == DragManager.MOVE) {
			        		...
			        		for (var i:int = 0; i < items.length; i++) {
			        			...
			        			this.dispatchEvent(new DragMoveCompletedEvent(DragMoveCompletedEvent.TYPE_DRAG_MOVE_COMPLETED, lastBranchNode, items[i]));
			        		}
