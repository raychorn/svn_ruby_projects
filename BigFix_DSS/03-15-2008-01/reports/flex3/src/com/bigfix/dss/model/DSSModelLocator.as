package com.bigfix.dss.model {
	...
	public class DSSModelLocator implements ModelLocator {
	  public var applicationName:String = 'Project Katamari';
		...
		[ArrayElementType("com.bigfix.dss.vo.FolderVO")]
		public var folders:ArrayCollection; // dashboard folders for this user, this is used only for inital loading and will become out of sync

		public var dashboard_folders:*; // dashboard folders for this user, this is used only for inital loading and will become out of sync

		public var dashboard_hierarchies:*; // dashboard folders for this user, this is used only for inital loading and will become out of sync
