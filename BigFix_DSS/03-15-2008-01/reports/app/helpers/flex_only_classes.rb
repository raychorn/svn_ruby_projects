...
require_dependency 'report_subject_property'
require_dependency 'all_property'
require_dependency 'property_type_operator'
require_dependency 'all_computer_group_distribution'
require_dependency 'aggregate_function'

class WebOrbResult
    attr_accessor :status, :type, :info, :statusMsg, :data
