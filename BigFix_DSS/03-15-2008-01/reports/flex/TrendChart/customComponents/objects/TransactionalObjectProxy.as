	...
	*/
	...
	public dynamic class TransactionalObjectProxy extends ObjectProxy {
		...
		public function commit():void {
			...
			/* // this old code would release all the previously queued events, but that kinda sucks since it would fire MultiplePropertyChangeEvent again...
			for each (var queuedEvent:PropertyChangeEvent in _queuedPropertyChangeEvents) {
